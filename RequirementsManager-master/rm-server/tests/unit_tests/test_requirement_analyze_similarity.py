...
from requirementmanager.api.requirement.analyze.similarity import META_SUCCESS

url = f"http://10.132.18.124:8080/requirement/analyze/similarity"

class TestRequirementAnalyzeSimilarity:
    ...
    def test_RequirementAnalyzeSimilarity_successful(self):
