...
@get_client_username
def project_baseline_node_create(client_username: str):
    body = request.json
    status_code, resp_body = projectmanager_http_client.post(
        'project/baseline/node/create', client_username, json=body
    )
